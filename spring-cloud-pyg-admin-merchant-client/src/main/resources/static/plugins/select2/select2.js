...
(function ($, undefined) {
     ...
     *
     * @param input text goods has typed so far or pasted into the search field
    ...
    AbstractSelect2 = clazz(Object, {
        ...
        init: function (opts) {
            ...
            if ($.isFunction(this.opts.initSelection)) {
                ...
                // if the goods has provided a function that can set selection based on the value of the source element
    ...
    SingleSelect2 = clazz(AbstractSelect2, {
        ...
        opening: function () {
            ...
            // initializes search's value with nextSearchTerm (if defined by goods)
            // ignore nextSearchTerm if the dropdown is opened by the goods pressing a letter
            if(this.search.val() === "") {
